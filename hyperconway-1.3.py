...
def render_universe(universe=[], rule=[]):
    ...
    if "X" in universe:
        ...
        color = offcolor
    C.create_polygon((a0[0] * math.sin((a0[1]) * (math.pi/7))*(scale/2) + (scale*0.55)),
                         (a0[0] * -math.cos((a0[1]) * (math.pi/7))*(scale/2) + (scale*0.55)),
                         (a0[0] * math.sin((a0[1]+2) * (math.pi/7))*(scale/2) + (scale*0.55)),
                         (a0[0] * -math.cos((a0[1]+2) * (math.pi/7))*(scale/2) + (scale*0.55)),
                         (a0[0] * math.sin((a0[1]+4) * (math.pi/7))*(scale/2) + (scale*0.55)),
                         (a0[0] * -math.cos((a0[1]+4) * (math.pi/7))*(scale/2) + (scale*0.55)),
                         (a0[0] * math.sin((a0[1]+6) * (math.pi/7))*(scale/2) + (scale*0.55)),
                         (a0[0] * -math.cos((a0[1]+6) * (math.pi/7))*(scale/2) + (scale*0.55)),
                         (a0[0] * math.sin((a0[1]+8) * (math.pi/7))*(scale/2) + (scale*0.55)),
                         (a0[0] * -math.cos((a0[1]+8) * (math.pi/7))*(scale/2) + (scale*0.55)),
                         (a0[0] * math.sin((a0[1]+10) * (math.pi/7))*(scale/2) + (scale*0.55)),
                         (a0[0] * -math.cos((a0[1]+10) * (math.pi/7))*(scale/2) + (scale*0.55)),
                         (a0[0] * math.sin((a0[1]+12) * (math.pi/7))*(scale/2) + (scale*0.55)),
                         (a0[0] * -math.cos((a0[1]+12) * (math.pi/7))*(scale/2) + (scale*0.55)),
    ...
    for direction in range(7):
        for cell in vertex_coords:
            ...
            if shape(vertex_coords[cell]) == 6:
                C.create_polygon((cell[0][0] * math.sin((cell[0][1] + (2*direction)) * (math.pi/7))*(scale/2) + (scale*0.55)),
                                     (cell[0][0] * -math.cos((cell[0][1] + (2*direction)) * (math.pi/7))*(scale/2) + (scale*0.55)),
                                     (cell[1][0] * math.sin((cell[1][1] + (2*direction)) * (math.pi/7))*(scale/2) + (scale*0.55)),
                                     (cell[1][0] * -math.cos((cell[1][1] + (2*direction)) * (math.pi/7))*(scale/2) + (scale*0.55)),
                                     (cell[2][0] * math.sin((cell[2][1] + (2*direction)) * (math.pi/7))*(scale/2) + (scale*0.55)),
                                     (cell[2][0] * -math.cos((cell[2][1] + (2*direction)) * (math.pi/7))*(scale/2) + (scale*0.55)),
                                     (cell[3][0] * math.sin((cell[3][1] + (2*direction)) * (math.pi/7))*(scale/2) + (scale*0.55)),
                                     (cell[3][0] * -math.cos((cell[3][1] + (2*direction)) * (math.pi/7))*(scale/2) + (scale*0.55)),
                                     (cell[4][0] * math.sin((cell[4][1] + (2*direction)) * (math.pi/7))*(scale/2) + (scale*0.55)),
                                     (cell[4][0] * -math.cos((cell[4][1] + (2*direction)) * (math.pi/7))*(scale/2) + (scale*0.55)),
                                     (cell[5][0] * math.sin((cell[5][1] + (2*direction)) * (math.pi/7))*(scale/2) + (scale*0.55)),
                                     (cell[5][0] * -math.cos((cell[5][1] + (2*direction)) * (math.pi/7))*(scale/2) + (scale*0.55)),
                ...
                C.create_polygon((cell[0][0] * math.sin((cell[0][1] + (2*direction)) * (math.pi/7))*(scale/2) + (scale*0.55)),
                                     ...
                                     (cell[5][0] * math.sin((cell[5][1] + (2*direction)) * (math.pi/7))*(scale/2) + (scale*0.55)),
                                     (cell[5][0] * -math.cos((cell[5][1] + (2*direction)) * (math.pi/7))*(scale/2) + (scale*0.55)),
                                     (cell[6][0] * math.sin((cell[6][1] + (2*direction)) * (math.pi/7))*(scale/2) + (scale*0.55)),
                                     (cell[6][0] * -math.cos((cell[6][1] + (2*direction)) * (math.pi/7))*(scale/2) + (scale*0.55)),
                                     outline=bordercolor, fill=color, width=1, tags=("clickable", ("X"+str(direction)+vertex_coords[cell])))
...
def genbuttons():
    resetgen = Button(C, font=("Arial", int(scale/50)), text="◀◀", command = lambda: [reset_generation()])
    prevgen = Button(C, font=("Arial", int(scale/50)), text=" ◀ ", command = lambda: [prev_generation()])
    nextgen = Button(C, font=("Arial", int(scale/50)), text=" ▶ ", command = lambda: [next_generation()])
    ...
    randomfill.place(x=1.12*scale, y=0.985*scale)
    radiusdown.place(x=1.23*scale, y=0.965*scale)
    radiusup.place(x=1.26*scale, y=0.965*scale)
    densitydown.place(x=1.31*scale, y=0.965*scale)
    densityup.place(x=1.34*scale, y=0.965*scale)
    clear.place(x=1.388*scale, y=0.985*scale)
...
def randomfill_options(option=""):
    ...
    C.create_text(1.257*scale, 1.02*scale, text="Radius", font=("Arial", int(scale/70), "bold"), tags=("randomfilltext"))
    C.create_text(1.257*scale, 1.04*scale, text=str(RADIUS), font=("Arial", int(scale/70), "bold"), tags=("randomfilltext"))
    C.create_text(1.338*scale, 1.02*scale, text="Density", font=("Arial", int(scale/70), "bold"), tags=("randomfilltext"))
    C.create_text(1.338*scale, 1.04*scale, text=str(DENSITY), font=("Arial", int(scale/70), "bold"), tags=("randomfilltext"))
    

def reset_generation():
    global GEN
    GEN = 0
    render_universe(UNIVERSE[GEN], RULE)
...
def neighbors(cell): # find adjacent cells
    ...
    if cell[-1] == "b":
        ...
        if cell2[-1] in "0123456":
            ...
            opp_hept = cell2[0:-1] + "R" + ((recurse-1)*"L")
        return [opp_hept+"La", opp_hept, opp_hept+"a", cell[0:-2], cell[0:-1]+"a", cell[0:-1]]
    elif cell[-1] == "a" and cell[-2] in "R":
        if cell[-3] == "R":
            return [cell[0:-2]+"LRb", cell[0:-1], cell[0:-1]+"b", cell[0:-2], cell[0:-2]+"La", cell[0:-2]+"L"]
        else:
            return [cell[0:-2]+"MRb", cell[0:-1], cell[0:-1]+"b", cell[0:-2], cell[0:-2]+"Ma", cell[0:-2]+"M"]
    elif cell[-1] == "a" and cell[-2] in "M":
        return [cell[0:-2]+"LRb", cell[0:-1], cell[0:-2]+"Ra", cell[0:-2], cell[0:-2]+"La", cell[0:-2]+"L"]
        ...
        if cell[-3] == "R":
            return [opp_hept+"Rb", cell[0:-1], cell[0:-2]+"Ra", cell[0:-2], opp_hept+"b", opp_hept]
        else:
            return [opp_hept+"Rb", cell[0:-1], cell[0:-2]+"Ma", cell[0:-2], opp_hept+"b", opp_hept]
    elif cell[-1] == "a" and cell[-2] in "0123456":
        return ["X"+str((int(cell[1])-1)%7)+"Rb", cell[0:-1], "X"+str((int(cell[1])+1)%7)+"a", "X", "X"+str((int(cell[1])-1)%7)+"a", "X"+str((int(cell[1])-1)%7)]
    ...
    # HEPTAGON CASE
        ...
        if cell2[-1] in "0123456":
            ...
            opp_hept = cell2[0:-1] + "R" + (recurse*"L")
        if cell[-2] == "R":
            return [cell+"Ra", cell+"Rb", opp_hept+"a", cell+"b", cell+"a", cell[0:-1]+"LRb", cell+"La"]
        else:
            return [cell+"Ra", cell+"Rb", opp_hept+"a", cell+"b", cell+"a", cell[0:-1]+"MRb", cell+"La"]
    elif cell[-1] == "M":
        return [cell+"Ma", cell+"Ra", cell+"Rb", cell[0:-1]+"Ra", cell+"a", cell[0:-1]+"LRb", cell+"La"]
    elif cell[-1] == "L":
        cell2 = cell; recurse = 0
        while cell2[-1] == "L":
            cell2 = cell2[0:-1]; recurse += 1
        ...
        if cell[-2] == "R":
            return [cell+"Ma", cell+"Ra", cell+"Rb", cell[0:-1]+"Ra", cell+"a", opp_hept+"b", cell+"La"]
        else:
            return [cell+"Ma", cell+"Ra", cell+"Rb", cell[0:-1]+"Ma", cell+"a", opp_hept+"b", cell+"La"]
    elif cell[-1] in "0123456":
        return [cell+"Ma", cell+"Ra", cell+"Rb", "X"+str((int(cell[1])+1)%7)+"a", cell+"a", "X"+str((int(cell[1])-1)%7)+"Rb", cell+"La"]
    elif cell[-1] == "X":
...
def compress_rule(rule):
    ...
    total_formations = [3, 7, 10, 8, 5, 2, 1, 1, 3, 7, 10, 8, 5, 2, 1]
    compressed = [[], [], [], [], [], [], [], [], [], [], [], [], [], [], []]
    string = "B"
...
def decompress_rule(string):
    outer_total = ["B1", "B2", "B3", "B4", "B5", "B6", "B7", "S0", "S1", "S2", "S3", "S4", "S5", "S6", "S7"]
    formation_symbol = ["hox", "chompax", "pogchambdx", "champgox", "phomx", "oa", "o", "o", "hox", "chompax", "pogchambdx", "champgox", "phomx", "oa", "o"]
...
def import_options():
    importbutton = Button(C, font=("Arial", int(scale/70), "bold"), text="Import from clipboard", command = lambda: [import_code(C.clipboard_get())])
